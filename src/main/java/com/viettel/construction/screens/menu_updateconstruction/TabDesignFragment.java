 ...
 */
public class TabDesignFragment extends BaseCameraFragment implements ImageInProcessAdapter.OnClickDelete {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tab_design, container, false);
    }
    ...
    public void reloadData(ConstructionExtraDTORequest data) {
        if (data != null) {
            ...
            if (data.getBlueprint_date() != null) {
                SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");

                Date _date = data.getBlueprint_date();
                if (_date != null) {
                    currentDate = _date;
            ...
            ApiManager.getInstance().getImagesByConstructionExtraIDType(
                    new ConstructionExtraDTOImageRequest("55", currentConstruction.getConstruction_id()),
    ...
    public void updateNewImage() {
        ...
        currentConstruction.setLstDesignImages(listImageUpdate);
    }
    ...
    public void selectTime() {
        ...
        DatePickerDialog datePickerDialog =
                new DatePickerDialog(getContext(), (datePicker, year, month, day) ->
                {
                    ...
                    currentConstruction.setBlueprint_date(currentDate);
