...
public class FullScreenAcceptanceActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }.getType());
        adapter = new FullScreenImageAdapter(FullScreenAcceptanceActivity.this,
                mListUrl, listener);
    ...
    private void initListImageFromServer() {
        mListUrl = AcceptanceLevel3CameraActivity.mListUrl;
        setUpViewPager();
