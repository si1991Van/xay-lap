...
public class CreateNewHSHCCameraActivity extends BaseCameraActivity {
    ...
    public void onClickSave() {
        try {
            ...
            if (tvConstruction.getText().length() == 0
                    || edtContentWork.getText().toString().length() == 0
    ...
    private void onSaveData() {
        ...
        ApiManager.getInstance().createNewWork(dto, ResultApi.class, new IOnRequestListener() {
            ...
            public <T> void onResponse(T result) {
                try {
                    ...
                    if (resultInfo.getStatus().equals(VConstant.RESULT_STATUS_OK)) {
                        Toast.makeText(CreateNewHSHCCameraActivity.this, "Tạo công việc thành công", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CreateNewHSHCCameraActivity.this, resultInfo.getMessage(), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void onError(int statusCode) {
                Toast.makeText(CreateNewHSHCCameraActivity.this, "Tạo công việc thất bại", Toast.LENGTH_SHORT).show();
            }
        });
    }
