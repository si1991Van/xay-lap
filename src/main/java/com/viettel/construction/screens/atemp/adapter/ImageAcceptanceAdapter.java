...
import com.viettel.construction.screens.images.FullScreenAcceptanceActivity;
...
public class ImageAcceptanceAdapter extends RecyclerView.Adapter<ImageAcceptanceAdapter.ImageViewHolder> {
    ...
    public ImageAcceptanceAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow,OnClickDelete onClickDelete) {
        this.mList = mList;
        this.isShow = isShow;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.IVItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, FullScreenAcceptanceActivity.class);
