...
public class FullScreenCompleteActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }.getType());
        adapter = new FullScreenImageAdapter(FullScreenCompleteActivity.this,
                mListUrl, listener);
    ...
    private void initListImageFromServer() {
        mListUrl = DetailCVCompleteCameraActivity.mListUrl;
        setUpViewPager();
