...
import com.viettel.construction.screens.atemp.other.FullScreenCreateEntangleActivity;
...
public class ImageCreateEntangleAdapter extends RecyclerView.Adapter<ImageCreateEntangleAdapter.ImageViewHolder> {
    ...
    public ImageCreateEntangleAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow) {
        this.mList = mList;
        this.isShow = isShow;
    ...
    public ImageCreateEntangleAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow, OnClickDelete onClickDelete) {
        this.mList = mList;
        this.isShow = isShow;
        this.mContext = context;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.IVItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, FullScreenCreateEntangleActivity.class);
