...
public class FullScreenCreateEntangleActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }.getType());
        adapter = new FullScreenImageAdapter(FullScreenCreateEntangleActivity.this,
                mListUrl, listener);
    ...
    private void initListImageFromServer() {
        mListUrl = CreateEntangleCameraActivity.mListUrl;
        setUpViewPager();
