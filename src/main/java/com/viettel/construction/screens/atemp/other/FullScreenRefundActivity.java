...
public class FullScreenRefundActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }.getType());
        adapter = new FullScreenImageAdapter(FullScreenRefundActivity.this,
                mListUrl, listener);
    ...
    private void initListImageFromServer() {
        mListUrl = RefundItemLevel3CameraActivity.mListUrl;
        setUpViewPager();
