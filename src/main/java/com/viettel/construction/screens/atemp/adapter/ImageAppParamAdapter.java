...
public class ImageAppParamAdapter extends RecyclerView.Adapter<ImageAppParamAdapter.ImageViewHolder> {
    ...
    public ImageAppParamAdapter(int codeSourceImage, List<ConstructionImageInfo> mList, Context context, Boolean isShow, OnClickDelete onClickDelete) {
