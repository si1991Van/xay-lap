...
import com.viettel.construction.screens.atemp.other.FullScreenCompleteActivity;
...
public class ImageCompleteAdapter extends RecyclerView.Adapter<ImageCompleteAdapter.ImageViewHolder> {
    ...
    public ImageCompleteAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow) {
        this.mList = mList;
        this.isShow = isShow;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.IVItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, FullScreenCompleteActivity.class);
