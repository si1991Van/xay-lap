...
public class FullScreenDetailEntangleActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }.getType());
        adapter = new FullScreenImageAdapter(FullScreenDetailEntangleActivity.this,
                mListUrl, listener);
    ...
    private void initListImageFromServer() {
        mListUrl = EntangleCameraActivity.mListUrl;
        setUpViewPager();
