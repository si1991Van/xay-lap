...
import com.viettel.construction.screens.atemp.other.FullScreenDetailEntangleActivity;
...
public class ImageDetailEntangleAdapter extends RecyclerView.Adapter<ImageDetailEntangleAdapter.ImageViewHolder> {
    ...
    public ImageDetailEntangleAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow) {
        this.mList = mList;
        this.isShow = isShow;
    ...
    public ImageDetailEntangleAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow, OnClickDelete onClickDelete) {
        this.mList = mList;
        this.isShow = isShow;
        this.mContext = context;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.IVItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, FullScreenDetailEntangleActivity.class);
...
////                        ((DetailInProcessActivity)mContext).mListUrlUpload.get(position).setStatus(-1);
