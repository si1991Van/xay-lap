...
import com.viettel.construction.screens.atemp.other.FullScreenCategoryActivity;
...
public class ImageCategoryAdapter extends RecyclerView.Adapter<ImageCategoryAdapter.ImageViewHolder> {
    ...
    public ImageCategoryAdapter(List<ConstructionImageInfo> mList, Context context, Boolean isShow) {
        this.mList = mList;
        this.isShow = isShow;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.IVItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, FullScreenCategoryActivity.class);
