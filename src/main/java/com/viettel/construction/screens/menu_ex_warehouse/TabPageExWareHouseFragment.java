 ...
 */
public class TabPageExWareHouseFragment extends Fragment {
    ...
    private TabPageExWarehouseAdapter adapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new TabPageExWarehouseAdapter(getFragmentManager());
    ...
    public interface ITabDeliveryChanged {
        void tabChanged();
    }
}
